...
const ButtonAdd = ({ handleClick }) => {
  return (
    <button
      onClick={handleClick}
      className='bg-black border-black border w-full rounded-md inline-flex items-center justify-center py-1 px-7 text-center text-sm font-medium text-white disabled:bg-gray-3 disabled:border-gray-3 disabled:text-dark-5 active:bg-[#1B44C8] active:border-[#1B44C8]'
    >
